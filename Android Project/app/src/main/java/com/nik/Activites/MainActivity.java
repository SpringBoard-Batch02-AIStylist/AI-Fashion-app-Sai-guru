...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ChatAdapter(messages, isUser);
        ...
        isUser.add("no");
        messages.add("Hi,\n" +
                "I am AI FashionGuru, your personal style assistant. You can ask me for outfit recommendations for any occasion. I'll suggest the best fashion choices for you.");
        ...
        im.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!userInput.isEmpty()) {
                    ...
                    generateContent(userInput+" "+"(for each item create a link like for example a white shirt link would be https://www.amazon.in/s?k=white+shirt)");
                } else {
    ...
    public String runInference(String input)
    {
        ...
        // TODO: Add code to run inference here.
